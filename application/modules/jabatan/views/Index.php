         ...
         <div class="modal-content">
             ...
             <form id="form" class="form-horizontal form-label-left">
                 ...
                 <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-primary simpan" data-link="<?= base_url('jabatan/tambah'); ?>">Simpan</button>
                 </div>
             </form>
         </div>
     </div>
     ...
     <div class="modal-dialog modal-lg">
         <div class="modal-content">
             ...
             <form class="form-horizontal form-label-left">
                 ...
                 <div class="modal-footer">
                     <button type="button" class="btn btn-default tutup" data-dismiss="modal">Tutup</button>
                     <button type="button" class="btn btn-primary edtsimpan" data-link="<?= base_url('jabatan/put'); ?>">Simpan</button>
                 </div>
             </form>
         </div>
     </div>
