             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
                 <div class="x_panel">
                     ...
                     <div class="x_content">
                         ...
                         <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" data-link=<?= base_url('laporandatakaskeluar'); ?> data-posisicol="6" data-foot="iuran" cellspacing="0" width="100%">
                             <thead>
                                 <tr>
