...
function init_daterangepicker_reservation() {
  "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation"), $("#reservation").daterangepicker({
    locale: {
      format:"DD-MM-YYYY"
    }
...
var linktable = $('#datatable-responsive').attr("data-link");
var table;
var aktiffooter = $('#datatable-responsive').data('foot');
var Colposition = $('#datatable-responsive').data('posisicol');
var Colposition1 = $('#datatable-responsive').data('posisicol1');
  ...
  if (console.log("run_datatables"), "undefined" != typeof $.fn.DataTable) {
    ...
    TableManageButtons = function () {
      ...
      table = $("#datatable-responsive").DataTable({
        ...
        $( api.column( 6 ).footer() ).html("Rp. " + formatNumber(debet));
        $( api.column( 7 ).footer() ).html("Rp. " + formatNumber(kredit));
        $( api.column( 8 ).footer() ).html();
      } else if (aktiffooter == 'iuran'){
        var total = api
        .column( Colposition )
        .data()
        .reduce( function(a,b) {
        ...
        $( api.column( Colposition ).footer() ).html("Rp. " + formatNumber(total));
      } else if (aktiffooter == 'kaskeluar'){
        var kktotal = api
          .column( 6 )
          .data()
          .reduce( function(a,b){
          ...
          $(api.column(0).footer()).html('Total');
          $(api.column(6).footer()).html("Rp. " + formatNumber(kktotal));
          $(api.column(7).footer()).html();
      } else if (aktiffooter == 'laporanjurnal') {
        var debet = api
        .column( 6 )
        .data()
        .reduce( function (a, b) {
    ...
    $( api.column( 7 ).footer() ).html("Rp. " + formatNumber(kredit));
        ...
        "ajax": {
          ...
          "type": "POST",
          "data": function ( d ) {
            var inputstart = $('[name="daterangepicker_start"]').val();
            var inputend   = $('[name="daterangepicker_end"]').val();
                    if(inputstart != '' && inputend != ''){
                          d.inputstart = inputstart;
                          d.inputend   = inputend;
                    }
                }
        },
        ...
        },
        {
          ...
          "targets": [Colposition,Colposition1]
        }
      ]
      }),
